...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_nodejs/releases/download/v6.0.5/rules_nodejs-1.7.0.tar.gz"],
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/bazel-toolchains/archive/6146252.tar.gz",
)
